    ...
    Child: function Child(enrichedProps) {
      ...
      var newProps = Object.assign({}, rest, {
        fixture: Object.assign({}, rest.fixture, {
          props: (0, _merge.recursive)(true, rest.fixture.props, enrichedProps)
        })
      });
...
var Wrapper = function (_React$Component) {
  ...
  function Wrapper(props) {
    ...
    _this.recursivelyMergeState = function (nextState) {
      _this.setState(function (s) {
        // Handle setState function arg like React.setState would
        if (typeof nextState === 'function') {
          nextState = nextState(s);
        }
        return (0, _merge.recursive)(true, s, nextState);
      });
    };
    ...
    _this.state = Object.assign({}, _this.extractControllersFunctionsObject(controllers, update, function () {
      return _this.recursivelyMergeState.apply(_this, arguments);
    }));
    return _this;
  }
  ...
  _createClass(Wrapper, [{
    ...
    value: function extractControllersFunctionsObject(controllers, injectedUpdate, injectedSetState) {
      var _this2 = this;
      ...
      var transformedControllerObject = Object.entries(controllers).map(function (_ref) {
        ...
        if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
          return _defineProperty({}, key, _this2.extractControllersFunctionsObject(value, injectedUpdate, injectedSetState));
        }
        // type == function: leaf
    ...
    value: function render() {
      ...
      var props = (0, _merge.recursive)(true, rest, this.state);
